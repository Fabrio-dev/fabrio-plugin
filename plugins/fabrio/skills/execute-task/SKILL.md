...
## Step 9.5 — Report What Isn't This Ticket
...
|---|---|
| you lacked knowledge you should have had, and would repeat the mistake | `record_learning` / `reinforce_learning` — Step 9 above |
